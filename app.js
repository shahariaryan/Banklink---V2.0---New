...
function displayMovements(account) {
  ...
  account.movements.forEach((mov, i) => {
    ...
    const displayCurrency = formattedCurrencies(
      mov,
      account.locale,
      account.currency
    );
...
function calcPrintBalance(account) {
  ...
  const displayBalance = formattedCurrencies(
    account.balance,
    account.locale,
    account.currency
  );
...
function calcDisplaySummary(account) {
  ...
  const displayDeposit = formattedCurrencies(
    totalDeposit,
    account.locale,
    account.currency
  );
  ...
  const displayInterest = formattedCurrencies(
    interest,
    account.locale,
    account.currency
  );
